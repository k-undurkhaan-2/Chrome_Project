...
COMMANDS: list[CommandDescriptor] = [
    ...
    _descriptor(
        ...
        related_commands=["report bundle export", "report bundle preview", "report bundle verify", "report manifest verify"],
    ),
    CommandDescriptor(
        command="report bundle export",
        category="report",
        purpose="Write a directory report bundle to the approved bundle output root.",
        read_only=False,
        writes_files=True,
        runs_ce=False,
        replacement_for_powershell=False,
        ...
        related_commands=["report bundle export --dry-run", "report bundle preview", "report bundle verify"],
    ),
    _descriptor(
    ...
    CommandDescriptor(
        ...
        category="report",
        purpose="Write a Markdown report to an approved report output root.",
        read_only=False,
        writes_files=True,
        runs_ce=False,
        replacement_for_powershell=False,
        ...
        related_commands=["report export --dry-run", "report preview"],
    ),
]
